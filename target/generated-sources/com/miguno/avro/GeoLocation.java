...
public class GeoLocation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 492949344602726884L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"GeoLocation\",\"namespace\":\"com.miguno.avro\",\"fields\":[{\"name\":\"latitude\",\"type\":\"double\",\"doc\":\"Latitude of the tweet location\"},{\"name\":\"longitude\",\"type\":\"double\",\"doc\":\"Longitude of the tweet location\"}]}");
  ...
  /** Latitude of the tweet location */
  private double latitude;
  /** Longitude of the tweet location */
   ...
   * @param latitude Latitude of the tweet location
   * @param longitude Longitude of the tweet location
   */
   ...
   * @return Latitude of the tweet location
   */
   ...
   * @return Longitude of the tweet location
   */
   ...
   */
  public static com.miguno.avro.GeoLocation.Builder newBuilder() {
    return new com.miguno.avro.GeoLocation.Builder();
  }
   ...
   * @return A new GeoLocation RecordBuilder
   */
  public static com.miguno.avro.GeoLocation.Builder newBuilder(com.miguno.avro.GeoLocation.Builder other) {
    if (other == null) {
      return new com.miguno.avro.GeoLocation.Builder();
    } else {
      return new com.miguno.avro.GeoLocation.Builder(other);
    }
  }
   ...
   * @return A new GeoLocation RecordBuilder
   */
  public static com.miguno.avro.GeoLocation.Builder newBuilder(com.miguno.avro.GeoLocation other) {
    if (other == null) {
      return new com.miguno.avro.GeoLocation.Builder();
    } else {
      return new com.miguno.avro.GeoLocation.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GeoLocation>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.miguno.avro.GeoLocation.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.miguno.avro.GeoLocation other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.latitude)) {
        this.latitude = data().deepCopy(fields()[0].schema(), other.latitude);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.GeoLocation.Builder setLatitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.GeoLocation.Builder clearLatitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.GeoLocation.Builder setLongitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.miguno.avro.GeoLocation.Builder clearLongitude() {
